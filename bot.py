...
def main():
    ...
    st.header("DocumentGPT For Mr.redesign22")
    ...
    with st.sidebar:
        ...
        # openai_api_key = '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'
        openai_api_key = ''
        openai_api_key = st.text_input("Enter your OpenAI API Key", key=openai_api_key , type="password")
